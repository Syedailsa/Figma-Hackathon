    ...
    <div>
      <section className="text-gray-600 body-font">
        <div className="container place-items-center">
          <div className="flex-col md:flex  flex-wrap -m-4">
            <div className=" flex gap-8 p-4 overflow-hidden">
              <div className="bg-white p-6 rounded-lg">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <button onClick={() => router.push("/renting-page")} className="w-[116px] h-[44px] text-white rounded-[10px] bg-[#3563E9] hover:bg-[#435fb3]">Rent Now</button>
                </div>
...
export const OneCard = () => {
  ...
  <button onClick={() => router.push("/checkout")} className="w-[116px] h-[44px] text-white rounded-[10px] bg-[#3563E9] hover:bg-[#435fb3]">Rent Now</button>
  </div>
